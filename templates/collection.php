...
<!-- Mirrored from demo.enpek.com/html-templates/dye/collection.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Oct 2024 08:18:08 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>Collection - Dye - Multipurpose Creative Shop Art & Photography HTML Template</title>
    <!--=================== Bootstrap core CSS ===================-->
...
<div class="paira-container pages-container">
    ...
    <form action="" method="GET" name="myform" onsubmit="formController();return false;">
                    ...
                    <div class="pull-right col-md-3 col-sm-3 col-xs-4">
                        <div class="account-ajax-cart pull-right">
                            <ul class="list-inline pull-right">
                                ...
                                <li class="dropdown cart-menu-body">
                                    <input type="submit" value="Submit" class="position-r">
                                    <!-- <img src="assets/images/shopping-bag.png" alt="" class="position-r"><span class="span">2</span></i> -->
    ...
    <main class="collection-page">
        ...
        <section class="latest-picture paira-margin-bottom-3">
            ...
            <!-- <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 margin-bottom-40 margin-top-30">
                        ...
                        <div class="col-sm-4 col-md-4 col-xs-12">
                            <div class="product text-center">
                                ...
                                <div class="product-hover">
                                    <h4 class="margin-clear"><a href="product.html">Looking big eyes look</a></h4>
                                    ...
                                    <div class="paira-wish-compare-con wish-compare-view-cart">
                                        <!-- <a href="#" class="product-cart-con btn btn-success" name="namenoorul" id="idnoorul" onclick="hello();"><i class="fa fa-shopping-cart"></i></a> -->
                                        <input type="checkbox" class="product-cart-con btn btn-success" name="namenoorul" id="idnoorul"><i class="fa fa-shopping-cart"></i></input>
                                        <!-- <input type="checkbox" name="noor" id="noor"> -->
    ...
    <input type="hidden" id="product-name" value="Looking big eyes look">
    <a href="#" class="product-cart-con btn btn-success" id="idnoorul" onclick="hello();"><i class="fa fa-shopping-cart"></i></a>
    <a href="#paira-quick-view" class="paira-quick-view quick-view btn btn-default"><i class="fa fa-search-plus"></i></a>
</div> -->


                                </div>
                                <!-- <input type="checkbox" class="product-cart-con btn btn-success addcart" name="namenoorul" id="idnoorul">
                                <div class="cad">ADD TO CART</div>
                                <i class="fa fa-shopping-cart"></i></input> -->

                                <input type="checkbox" class="btn" id="vehicle1" name="vehicle1" value="Bike">
  <label for="vehicle1" class="btn">ADD TO CART <i class="fa fa-shopping-cart"></i></label>
  </input>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-xs-12">
                            <div class="product text-center">
                                ...
                                <div class="product-hover">
                                    ...
                                    <div class="paira-wish-compare-con wish-compare-view-cart">
                                        ...
                                        <input type="checkbox" class="product-cart-con btn btn-success" name="namenoorul2" id="idnoorul2"><i class="fa fa-shopping-cart"></i></input>
                                        <a href="#paira-quick-view" class="paira-quick-view quick-view  btn btn-default"><i class="fa fa-search-plus"></i></a>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function(){
    ...
    $('#form_details').on('submit', function(e){
                ...
                formData.append('type', 'add_users');
                            $.ajax({
                            url: 'apis/users.php',
                            type: 'post',
                            dataType: 'json',
...
<!-- Mirrored from demo.enpek.com/html-templates/dye/collection.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Oct 2024 08:18:15 GMT -->
</html>